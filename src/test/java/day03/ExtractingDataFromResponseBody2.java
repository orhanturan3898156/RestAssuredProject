...
public class ExtractingDataFromResponseBody2 {
...
//        System.out.println("Awards are "  + responseMap.get("Awards"));
        ...
        //above code is doing below when get mao method is called.
        //Map<String,Object> manualMap=new HashMap<>();
        //manualMap.put("Source","Movie Database");
        //manualMap.put("Value","6.3/10")

        //I want to store all the source into a list of string

        List<String> list=jp.getList("Ratings.Source");

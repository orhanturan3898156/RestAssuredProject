...
public class LibraryAppReusingTheSpecification {
    ...
    @DisplayName("Testing GET/get all users Endpoint with spec")
    @Test
    public void testGetAllUsers() {
        given()
                ...
                .get("/get_all_users")
                .then()
                .spec(responseSpec) //we can add more validation

        ;

    }

    @DisplayName("Testing GET/dashboard stats Endpoint with spec")
    @Test
    public void testGetDasboardStatus() {
        given()
                .spec(requestSpec)
                .when()
                .get("/dashboard_stats")

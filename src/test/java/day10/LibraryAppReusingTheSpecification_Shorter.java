...
public class LibraryAppReusingTheSpecification_Shorter {
    ...
    public void testGetAllUsers() {
        ...
        List<User> allUserlist = response.jsonPath().getList("", User.class); //if we wanto get all of them we use ""
        //when we say "User.class" it will return in the type of User class.
    ...
    public void testGet_Dashboard_stats() {
        ...
        Map<String, Object> statMap = response.jsonPath().getMap("");//if we wanto get all of them we use ""
